  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case RouteNames.diary:
        return MaterialPageRoute(builder: (context) => DiaryScreen());
      case RouteNames.diarylog:
        return MaterialPageRoute(builder: (context) => DiaryLogScreen());
      case RouteNames.welcomeScreen:
        return MaterialPageRoute(builder: (context) => Welcome());
      case RouteNames.reminder:
        return MaterialPageRoute(builder: (context) => Reminders());
        case RouteNames.peakflow:
        return MaterialPageRoute(builder: (context) => PeakFlow());
       case RouteNames.addpeak:
        return MaterialPageRoute(builder: (context) => AddPeakFlow());
